...
function my_acf_init_block_types()
{
    ...
    if (function_exists('acf_register_block_type')) {
        ...
        // register a custom style block.
        acf_register_block_type(array(
            'name' => 'custom_style',
            'title' => __('Custom Styles'),
            'description' => __('A custom style block.'),
            'render_template' => 'template-parts/blocks/custom_styles.php',
            'keywords' => array('custom', 'user', 'field', 'style'),
        ));
    }
}